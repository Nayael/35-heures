var Payslip = (function(AssetManager, TimeManager, ScoreManager) {
    ...
    Payslip.prototype.displayInfoWeek = function(info) {
        ...
        if (ScoreManager.instance.daysScore.length > 1) {
            // Mardi
        ...
        if (ScoreManager.instance.daysScore.length > 2) {
            // Mercredi
        ...
        if (ScoreManager.instance.daysScore.length > 3) {
            // Jeudi
        ...
        if (ScoreManager.instance.daysScore.length > 4) {
            // Vendredi
